...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        train_dataloader = DataLoader(self.train_dataset, batch_size=4, shuffle=True, collate_fn=self.data_collator)
        ...
        if has_length(train_dataloader):
            ...
            num_train_epochs = 10 #sys.maxsize
        ...
        for epoch in range(epochs_trained, 10):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                # if step == 1:
                #     loss_kd_1 = tr_loss_step
                # if step == 2:
                #     loss_kd_2 = tr_loss_step
                # if step == 3:
                #     loss_kd_3 = tr_loss_step
                # else:
                #     loss_kd_1 = loss_kd_2
                #     loss_kd_2 = loss_kd_3
                #     loss_kd_3 = tr_loss_step
                ...
                if (
                    ...
                    tr_loss += tr_loss / (1 + self.state.global_step - self._globalstep_last_logged) + loss_kd_1 #(loss_kd_1 + loss_kd_2 + loss_kd_3) 
                else:
                    tr_loss += tr_loss_step + loss_kd_1 #(loss_kd_1 + loss_kd_2 + loss_kd_3) 
